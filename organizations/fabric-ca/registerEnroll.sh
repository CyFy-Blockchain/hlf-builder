...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u https://$ORG_ADMIN_NAME:$ORG_ADMIN_PASSWORD@$ORG_CA_URL:$ORG_CA_PORT --caname ca-$ORG_NAME --tls.certfiles "${PWD}/organizations/fabric-ca/$ORG_NAME/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@$ORG_CA_URL:$ORG_CA_PORT --caname ca-$ORG_NAME -M "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/$ORG_NAME/ca-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/msp/config.yaml"

  infoln "Generating the peer0-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@$ORG_CA_URL:$ORG_CA_PORT --caname ca-$ORG_NAME -M "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/tls" --enrollment.profile tls --csr.hosts peer0.$ORG_NAME.ums.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/$ORG_NAME/ca-cert.pem"
  { set +x; } 2>/dev/null

  # Copy the tls CA cert, server cert, server keystore to well known file names in the peer's tls directory that are referenced by peer startup config
  cp "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/tls/ca.crt"
  cp "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/tls/signcerts/"* "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/tls/server.crt"
  cp "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/tls/keystore/"* "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/peers/peer0.$ORG_NAME.ums.com/tls/server.key"

  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@$ORG_CA_URL:$ORG_CA_PORT --caname ca-$ORG_NAME -M "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/users/User1@$ORG_NAME.ums.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/$ORG_NAME/ca-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/users/User1@$ORG_NAME.ums.com/msp/config.yaml"

  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://org1admin:org1adminpw@$ORG_CA_URL:$ORG_CA_PORT --caname ca-$ORG_NAME -M "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/users/Admin@$ORG_NAME.ums.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/$ORG_NAME/ca-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/$ORG_NAME.ums.com/users/Admin@$ORG_NAME.ums.com/msp/config.yaml"
}
